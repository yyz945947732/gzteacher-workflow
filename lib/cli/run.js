...
async function runTasks(options) {
  try {
    ...
    const contextBase = defaults({ branchName, username }, DEFAULT_CONTEXT);
    ...
    const versionFileName = getVersionFileName !== false ? getVersionFileName(context) : undefined;
